          ...
          <form method="GET" action="" class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"> 
            ...
            <div class="relative w-full sm:w-1/2">
              <input 
                ...
                class="pl-10 pr-4 py-2 w-full border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm 
                      focus:ring-2 focus:ring-blue-400 dark:bg-gray-800 dark:text-white text-sm">
