  ...
  <body class="bg-white dark:bg-[#1a1a1a] text-gray-700 dark:text-gray-200 transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
      ...
      <main class="flex-1 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <div class="flex items-center gap-2">
            <a href="{{ route('excerpts.index') }}" 
              class="px-2 py-2 border rounded-xl dark:bg-gray-800 dark:text-white text-sm">
              Back to Excerpts
            </a>
        ...
        <!-- Filters and Search -->
        <div class="p-4 border rounded-xl bg-white dark:bg-gray-900 mb-6 shadow-sm">
          <form method="GET" action="" class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"> 
            ...
            <div class="relative w-full sm:w-1/2">
              <input 
                ...
                class="pl-10 pr-4 py-2 w-full border rounded-xl focus:ring-2 focus:ring-blue-400 dark:bg-gray-800 dark:text-white text-sm">
        ...
        <!-- Results Table -->
        <div class="border rounded-2xl bg-white dark:bg-gray-900 shadow-sm">
          <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
              ...
              @empty
                <tr>
                  <td colspan="5" class="px-6 py-10 text-center text-gray-500 italic">No documents yet</td>
                </tr>
              @endforelse
            </tbody>
          </table>
