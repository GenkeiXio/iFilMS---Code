...
<nav class="navbar navbar-light bg-white border-bottom">
  <div class="container">
    ...
    <div>
      <a href="{{ route('minutes.index') }}" class="btn btn-outline-secondary btn-sm">All Minutes</a>
    </div>
  </div>
</nav>
...
<div class="modal fade" id="uploadModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0">
      ...
      <form method="POST" action="{{ route('minutes.upload', $category) }}" enctype="multipart/form-data">
        @csrf
