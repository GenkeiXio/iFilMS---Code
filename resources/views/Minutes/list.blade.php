      ...
      <main class="flex-1 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <div class="flex items-center gap-2">
            <!-- All Minutes Button -->
            <a href="{{ route('minutes.index') }}" class="px-2 py-2 border border-gray-300 dark:border-gray-600 rounded-xl dark:bg-gray-800 dark:text-white text-sm">
              All Minutes of the Meeting Folders
            </a>
