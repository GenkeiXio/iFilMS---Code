...
<head>
  <meta charset="UTF-8">
  <title>{{ $title }} • Transcriptions</title>
...
<body>
  <nav class="navbar navbar-light bg-white border-bottom">
    <div class="container">
      <a class="navbar-brand fw-bold" href="{{ url('/dashboard') }}">iFiLMS Trancriptions</a>
      <div>
        <a href="{{ route('transcriptions.index') }}" class="btn btn-outline-secondary btn-sm">All Transcriptions</a>
      </div>
    </div>
  </nav>
  ...
  <div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3">
      ...
      <div class="small text-muted">Page 1 of 1</div>
    </div>
  </div>
  ...
  <div class="modal fade" id="uploadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0">
        ...
        <form method="POST" action="{{ route('transcriptions.upload', $category) }}" enctype="multipart/form-data">
          @csrf
          <div class="modal-body">
            <div class="dropzone" id="dropzone">
              <p class="mb-2 fw-semibold">Drag & drop file here</p>
              <p class="text-muted small">or click to choose a file (PDF, DOC, DOCX, TXT, XLS, XLSX)</p>
  ...
  <script>
    (function() {
      ...
      // When user picks file via dialog
